...
ALLOWED_HOSTS = [
    'plagiarismcheckerpyresearch.herokuapp.com',
    'localhost',
    '127.0.0.1',
]
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Added/Confirmed this line
...
LOGIN_REDIRECT_URL = 'blog_list'      # after successful login
LOGOUT_REDIRECT_URL = 'login'       # after successful logout
LOGIN_URL = 'login'                 # URL for login page
AUTH_USER_MODEL = 'plagiarismchecker.CustomUser'